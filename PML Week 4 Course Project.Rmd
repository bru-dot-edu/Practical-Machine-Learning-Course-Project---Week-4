...
```{r}
train <- read.csv('C:/Users/cbrueck/Documents/Coursera/Practical-Machine-Learning-Course-Project---Week-4/pml-training.csv', header=T, na.strings=c("NA", ""))
anyNA.train <- sapply(train, function(x) sum(is.na(x)))
train <- train[anyNA.train == 0]
train <- train[,-c(1:7)]

test <- read.csv('C:/Users/cbrueck/Documents/Coursera/Practical-Machine-Learning-Course-Project---Week-4/pml-testing.csv', header=T, na.strings=c("NA", ""))
